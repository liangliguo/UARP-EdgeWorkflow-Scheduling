...
| 阶段 | 状态 | 说明 |
|---|---|---|
| 1 项目骨架 | ☑ | uv + pymoo/networkx/numpy/matplotlib + pytest |
| 2 系统模型 | ☑ | 公式 1–16，9 个手工 DAG 单元测试 |
| 3 编码与适应度 | ☑ | pymoo Problem，整数染色体 |
| 4 NSGA-III + SAW | ☑ | pymoo NSGA3 + SAW/MCDM；6 个测试 |
| 5 基线 | ☑ | Benchmark/FF/WF；5 个测试 |
| 6 不确定性 + Alg.2 | ☑ | 三类事件 + Algorithm 2；9 个测试 |
| 7 实验复现 | ☑ | Figure 5–9 全部生成，趋势与论文一致 |

合计预估：**5–6 工作日** / 实际：**1 个会话**。
